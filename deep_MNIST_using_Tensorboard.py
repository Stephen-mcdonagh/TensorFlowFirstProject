...
#   12/06/2019
#   Deep Neural Network to classify greyscale handwritten digits from MNIST dataset

#   Hidden convolution and pool layers added to make more accurate
#   (Convoluted & Pool Layer 1) -> (Convoluted & Pool Layer 2 ) -> (Fully connected layer(Puts together details))

# Using tensorboard for logging and debugging
# using the command 'tensorboard --logdir tensorboard_logs' will give us a web server will all the information we need 
