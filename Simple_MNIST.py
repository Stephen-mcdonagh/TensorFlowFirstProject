...
#One hot = true -> only returns the highest probability digit
mnist = input_data.read_data_sets("MNIST_data/", one_hot=True)

# x is placeholder for the 28 X 28 image data
#placeholder 'x' is a tensor 
...
#below is defined as variables as we will be changing these values as the model learns
#initally all set to 0
W = tf.Variable(tf.zeros([784, 10]))
#10 neurons as the digits represented is 0 -> 9
